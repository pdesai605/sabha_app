...
import { MODULE_NAV } from "@/modules/voter-intelligence/constants";

export function VoterIntelligenceNav() {
  ...
  return (
    <nav className="flex gap-1 overflow-x-auto pb-1 -mx-1 px-1">
      {MODULE_NAV.map((item) => {
        const isActive =
          item.href === "/voter-intelligence"
            ? pathname === "/voter-intelligence"
